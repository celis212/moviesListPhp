            ...
            <div class="row">
                <div class="col">
                    ...
                    <input 
                        ...
                        value="<?php echo (!empty($data['titleSearch'])) ? $data['titleSearch'] : ''; ?>"
                    >
                    ...
                    <div class="row">
                        <div class="col">
                            <input 
                                ...
                                value="<?php echo (!empty($data['dateStart'])) ? $data['dateStart'] : ''; ?>"
                            >
                        ...
                        <div class="col">
                            <input 
                                ...
                                value="<?php echo (!empty($data['dateEnd'])) ? $data['dateEnd'] : ''; ?>"
                            >
                ...
                <div class="col">
                    ...
                    <select class="form-control form-control-lg" name='sortBy' aria-label="Default select example">
                        <option 
                            value="Title" 
                            <?php  if(!empty($data['sortBy']) && $data['sortBy'] === 'Title') echo "selected"; ?>
                        >
                            Title
                        </option>
                        <option 
                            value="Date"  
                            <?php  if(!empty($data['sortBy']) && $data['sortBy'] === 'Date') echo "selected"; ?>
                        >
                            Date
                        </option>
                    </select>
                    ...
                    <label for="name">Sort by:</label>
                        <input 
                            ...
                            name="when" 
                            value="asc" 
                            <?php  if(!empty($data['when']) && $data['when'] === 'asc') echo "checked"; ?>
                        >
                        Asc
                        <input 
                            type="radio"
                            name="when" 
                            value="desc" 
                            <?php if(!empty($data['when']) && $data['when'] === 'desc') echo "checked";  ?>
                        >
                        Desc
                    </p>
                </div>
